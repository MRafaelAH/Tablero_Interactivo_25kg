...
if (isMobile) {
    // Limitamos el ratio de píxeles para que el teléfono no sufra
    app.renderer.setPixelRatio(Math.min(window.devicePixelRatio, 1.5));
    
    // Desactivamos sombras para ganar fluidez total en el celular
    app.renderer.shadowMap.enabled = false;
    
    console.log("Optimización para móvil activada correctamente");
}
// --- MONITOR DE RENDIMIENTO MANUAL ---
(function() {
