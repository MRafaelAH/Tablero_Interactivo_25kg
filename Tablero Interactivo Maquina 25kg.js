...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || 'Tablero Interactivo Maquina 25kg.gltf',
...
if (v3d.AppUtils.isMobile()) {
    // Limitamos el ratio de píxeles a 1.5 (el estándar es 2 o 3 en gama alta)
    // Esto le quita un 40% de carga de trabajo a la GPU del teléfono
    app.renderer.setPixelRatio(Math.min(window.devicePixelRatio, 1.5));
    
    // Opcional: Desactivar sombras pesadas solo en móvil para ganar más FPS
